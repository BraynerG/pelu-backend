...
__decorate([
    ...
    (0, class_validator_1.IsNotEmpty)({ message: 'El nombre del cliente es requerido' }),
    __metadata("design:type", String)
], CreateReservationDto.prototype, "customerName", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    (0, class_validator_1.IsNotEmpty)({ message: 'El teléfono del cliente es requerido' }),
    __metadata("design:type", String)
...
__decorate([
    (0, class_validator_1.IsUUID)('4', { message: 'El ID del servicio debe ser un UUID válido' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'El ID del servicio es requerido' }),
    __metadata("design:type", String)
], CreateReservationDto.prototype, "serviceId", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
